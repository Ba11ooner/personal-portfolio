                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        <Nav className="ms-auto">
                            <Nav.Link href="#home"
                                      ...
                                      onClick={() => onUpdateActiveLink('home')}>主页</Nav.Link>
                            <Nav.Link href="#skills"
                                      className={activeLink === 'skills' ? 'active navbar-link' : 'navbar-link'}
                                      onClick={() => onUpdateActiveLink('skills')}>技能</Nav.Link>
                            <Nav.Link href="#projects"
                                      className={activeLink === 'projects' ? 'active navbar-link' : 'navbar-link'}
                                      onClick={() => onUpdateActiveLink('projects')}>项目</Nav.Link>
                        </Nav>
                        <span className="navbar-text">
                              ...
                              <HashLink to='#connect'>
                                <button className="vvd"><span>与我联系</span></button>
                              </HashLink>
                        </span>
                    </Navbar.Collapse>
                </Container>
